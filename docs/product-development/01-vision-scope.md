...
**Vela** là nền tảng **LMS doanh nghiệp đa tổ chức (multi-tenant enterprise LMS)** giúp các doanh nghiệp Việt Nam **đào tạo nội bộ, quản lý năng lực và đo lường hiệu quả đào tạo** ở quy mô lớn. Sản phẩm kết hợp:
...
- Mỗi doanh nghiệp = 1 tổ chức (tenant); Vela là nhà cung cấp SaaS host nhiều tổ chức.
